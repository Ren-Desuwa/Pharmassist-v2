...
//   {"NOTIF-001", "Stock Alert: Medicine 5", "Limited stock remaining. Your prescription RX-2024-002 may experience delays. Alternative formulation available.", "urgent", "high", "30 minutes ago", false, true, "RX-2024-002", "admin"},
//   {"NOTIF-002", "Prescription Approved", "Medicine 2 prescription for Sarah Wilson has been approved by pharmacy. Ready for dispensing.", "success", "normal", "2 hours ago", true, false, "RX-2024-001", "admin"},
  
//   // Notifications for Dr. Sarah Johnson (doctor1)
//   {"NOTIF-003", "Patient Update Required", "Medicine 7 dosage for Lisa Williams requires adjustment based on latest INR results. Please review.", "urgent", "high", "1 hour ago", false, true, "RX-2024-006", "doctor1"},
//   {"NOTIF-004", "Prescription Dispensed", "Medicine 4 for James Anderson has been successfully dispensed. Patient notified for collection.", "success", "normal", "4 hours ago", true, false, "RX-2024-007", "doctor1"},
  
//   // Notifications for Dr. Michael Chen (doctor2)
//   {"NOTIF-005", "Emergency Medication Available", "Medicine 6 for Emma Thompson is now ready for immediate collection from emergency pharmacy.", "success", "urgent", "15 minutes ago", false, true, "RX-2024-003", "doctor2"},
//   {"NOTIF-006", "Drug Interaction Alert", "Potential interaction detected between prescribed Medicine 9 and patient's existing Medicine 7 therapy for Maria Garcia. Review recommended.", "urgent", "high", "45 minutes ago", false, true, "RX-2024-008", "doctor2"}
// };

// std::vector<Prescription> prescriptions = {
//   // ---------------- Test User ----------------
//   {"RX-2024-100", "Maria Garcia", "MRN-55667788", "emergency", "ER-07",
//    {{"Medicine 1","500mg","capsule",20}, {"Medicine 8","500mg","tablet",20}},
//    "oral", "every 8 hours", "routine", "Respiratory infection", "Take after meals", "pending",
//    "2024-01-20", "Test User", "test"},
//   {"RX-2024-101", "Robert Chen", "MRN-23456789", "outpatient", "",
//    {{"Medicine 3","500mg","tablet",30}, {"Medicine 2","10mg","tablet",30}},
//    "oral", "once daily", "routine", "Hypertension + Diabetes", "Monitor blood sugar weekly",
//    "dispensing", "2024-01-21", "Test User", "test"},
//   {"RX-2024-102", "James Anderson", "MRN-11223344", "internal", "Ward-B-15",
//    {{"Medicine 8","500mg","tablet",20}},
//    "oral", "every 6 hours", "urgent", "Fever management", "Hydrate well",
//    "ready", "2024-01-22", "Test User", "test"},

//   // ---------------- Dr. John Smith ----------------
//   {"RX-2024-001", "Sarah Wilson", "MRN-78901234", "cardiology", "Ward-A-12",
//    {{"Medicine 2","10mg","tablet",30}},
//    "oral", "once daily", "routine", "Hypertension management", "Monitor blood pressure weekly",
//    "dispensing", "2024-01-16", "Dr. John Smith", "admin"},
//   {"RX-2024-002", "Michael Rodriguez", "MRN-56789012", "internal", "Ward-B-08",
//    {{"Medicine 5","100IU/ml","injection",3}},
//    "subcutaneous", "once daily", "urgent", "Diabetes mellitus type 1",
//    "Rotate injection sites", "pending", "2024-01-16", "Dr. John Smith", "admin"},
//   {"RX-2024-009", "Robert Chen", "MRN-23456789", "outpatient", "",
//    {{"Medicine 3","500mg","tablet",60}},
//    "oral", "twice daily", "routine", "Type 2 diabetes", "Take with meals",
//    "ready", "2024-01-15", "Dr. John Smith", "admin"},
//   // Multi-medication example
//   {"RX-2024-012", "James Anderson", "MRN-11223344", "internal", "Ward-B-15",
//    {{"Medicine 4","20mg","tablet",30}, {"Medicine 8","500mg","tablet",10}},
//    "oral", "once daily", "routine", "Hypercholesterolemia + pain relief",
//    "Check liver function in 6 weeks", "pending", "2024-01-18", "Dr. John Smith", "admin"},

//   // ---------------- Dr. Sarah Johnson ----------------
//   {"RX-2024-006", "Lisa Williams", "MRN-12345678", "cardiology", "Ward-A-25",
//    {{"Medicine 7","5mg","tablet",30}},
//    "oral", "once daily", "routine", "Atrial fibrillation", "Monitor INR weekly",
//    "partially-dispensed", "2024-01-14", "Dr. Sarah Johnson", "doctor1"},
//   {"RX-2024-007", "James Anderson", "MRN-11223344", "internal", "Ward-B-15",
//    {{"Medicine 4","20mg","tablet",30}},
//    "oral", "once daily", "routine", "Hypercholesterolemia",
//    "Check liver function in 6 weeks", "dispensed", "2024-01-13", "Dr. Sarah Johnson", "doctor1"},
//   {"RX-2024-010", "Sarah Wilson", "MRN-78901234", "cardiology", "Ward-A-12",
//    {{"Medicine 8","81mg","tablet",30}}, // Aspirin replaced with Medicine 8 from the static list
//    "oral", "once daily", "routine", "Cardiovascular prophylaxis",
//    "Take with food", "ready", "2024-01-16", "Dr. Sarah Johnson", "doctor1"},

//   // ---------------- Dr. Michael Chen ----------------
//   {"RX-2024-003", "Emma Thompson", "MRN-34567890", "emergency", "ER-03",
//    {{"Medicine 6","1mg/ml","injection",2}},
//    "intramuscular", "stat", "stat", "Anaphylactic reaction",
//    "Have second dose available", "ready", "2024-01-16", "Dr. Michael Chen", "doctor2"},
//   {"RX-2024-008", "Maria Garcia", "MRN-55667788", "emergency", "ER-07",
//    {{"Medicine 9","250mg","tablet",6}},
//    "oral", "once daily", "urgent", "Community-acquired pneumonia",
//    "Complete full course even if feeling better", "dispensing", "2024-01-16", "Dr. Michael Chen", "doctor2"},
//   {"RX-2024-011", "Emma Thompson", "MRN-34567890", "emergency", "ER-03",
//    {{"Medicine 9","20mg","tablet",5}}, // replaced with Medicine 8 to stay inside static 9
//    "oral", "once daily", "urgent", "Allergic reaction follow-up",
//    "Taper dose as directed", "pending", "2024-01-16", "Dr. Michael Chen", "doctor2"}
// };
...
//       Serial.printf("    %d. %s (%d) %s (%s) x%d\n", 
//                    (int)i+1, med.medicationName.c_str(), getMedicationIndex(med.medicationName), med.dosageForm.c_str(), med.quantity);
//     }
...
//       // add medication dispense logic here
